...
<body>
	...
	<div class="wrapper">
		<div class="wrap">
			...
			<div class="deli_check">
				<p style="font-size:15px; font-weight: 450;">배송조회
					: 서비스 준비중 입니다.</p><br>
			</div><hr>
			...
			<div class="orderer_detail">
				<table class="orderer_detail_table">
			...
			<div class="deli_detail">
				<table class="deli_detail_table">
